...
namespace EOfficeBNILAPI.Models
{
    ...
    public class ParamInsertMemo
    {
        ...
        public string idUserChecker { get; set; }

        public string idUserApprover { get; set; }

        public string idUserCheckerPenerima { get; set; }

        public string idUserCheckerCarbonCopy { get; set; }


        public string idUserCheckerDelibretion { get; set; }

        public string idUserCheckerlain { get; set; }
    ...
    public class OutputDeatilMemoMobile
    {
        public OutputListAttachmentMemo docLetter { get; set; }
    ...
    public class ParamInsertMemoBackDate
    {
        ...
        public string idUserCheckerPengirim { get; set; }
        ...
        public string idUserDelibration { get; set; }
    ...
    public class OutputListDeliberationMemoModel
    {
        ...
        public int statuscodeDelibration { get; set; }
    ...
    public class ParamInsertMemoPengadaan
    {
        ...
        public string idUserApprovalPengadaan { get; set; }
