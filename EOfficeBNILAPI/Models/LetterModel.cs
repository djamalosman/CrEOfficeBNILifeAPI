...
namespace EOfficeBNILAPI.Models
{
    public class ParamInsertLetter
    {
        ...
        // idDocument ini isinya id Document Receiver
        ...
        public string idUserCopy { get; set; }
    ...
    public class OutputDetailLetter
    {
        ...
        public List<OutputListApproval> approval { get; set; }
    ...
    public class ParamInsertApproval
    {
