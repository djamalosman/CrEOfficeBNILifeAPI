...
namespace EOfficeBNILAPI.Controllers
{
    ...
    public class TemplateBulkController : Controller
    {
        private readonly IDataAccessProvider _dataAccessProvider;
        GeneralOutputModel output = new GeneralOutputModel();
        SessionUser sessionUser = new SessionUser();
        public TemplateBulkController(IDataAccessProvider dataAccessProvider)
        {
            _dataAccessProvider = dataAccessProvider;
        }

        [HttpGet(Name = "SetSessionTemplateBulk")]
        ...
        [Authorize]
        [Route("InsertTemplateBulk")]
        [HttpPost]
        public ActionResult InsertTemplateBulk([FromForm] ParamInsertContentTemplateBulk pr)
        {
            try
            {
                sessionUser = SetSession();
                GeneralOutputModel retrn = _dataAccessProvider.AddContentTemplateBulk(pr, sessionUser);
